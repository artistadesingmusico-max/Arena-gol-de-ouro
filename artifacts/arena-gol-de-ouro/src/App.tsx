...
function Hero() {
  return <section id="topo" className="hero-glow relative min-h-[720px] overflow-hidden border-b border-white/10 bg-[#0e1118] pt-28">
    <img src={aerialImage} alt="Vista aérea da Arena Gol de Ouro ao pôr do sol" className="absolute inset-0 h-full w-full object-cover opacity-45" />
...
function Facilities({ facilities, onSelect }: { facilities: Facility[]; onSelect: (id: number) => void }) {
  ...
  return <section id="estrutura" className="arena-grid border-y border-[#252d38] bg-[#111720] px-5 py-24 lg:px-8">
